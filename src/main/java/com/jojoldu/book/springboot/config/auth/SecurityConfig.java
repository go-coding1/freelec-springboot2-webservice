...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    * h2-console화면을 사용하기 위해 해당 옵션들을 disable 합니다.
    *
    * authorzieRequest
    *   1.URL별 권한 관리를 설정하능 옵션의 시작점입니다.
    *   2.authorizeRequests가 선언되어야만 antMatchers옵션을 사용할 수 있습니다.
    *
    * antMatchers
    *   1. 권한 관리 대상을 지정하는 옵션입니다.
    *   2. URL, HTTP메소드별로 관리가 가능합니다.
    *   3. "/"등 지정된 URL들은 permitAll() 옵션을 통해 전체 열람 권한을 주었습니다.
